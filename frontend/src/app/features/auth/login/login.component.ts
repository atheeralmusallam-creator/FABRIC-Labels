    ...
    <div class="login-shell">
      <div class="login-card glass">
        <div class="login-header">
          ...
          <h1>FABRIC Platform</h1>
          <p>AI-Assisted Human Evaluation</p>
        </div>
        ...
        <form class="login-form" (ngSubmit)="submit()">
          <div class="field">
            ...
            <input type="email" [(ngModel)]="email" name="email"
                   placeholder="admin@fabric.ai" required autocomplete="email" />
          </div>
          <div class="field">
        ...
        <div class="login-footer">
          <a routerLink="/customer/login">Customer portal →</a>
        </div>
      </div>
    </div>
  `,
