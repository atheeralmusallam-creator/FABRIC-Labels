...
public class UserService
{
    ...
    public async Task<List<UserDto>> ListAsync() =>
        await _db.Users.Select(u => new UserDto(u.Id, u.Email, u.Name, u.Role, u.Roles, u.MustChangePassword, u.CreatedAt))
                       .ToListAsync();
...
public class ProjectService
{
    ...
    public async Task<ProjectDto?> UpdateAsync(string id, UpdateProjectRequest req)
    {
        var p = await _db.Projects.Include(x => x.Tasks).FirstOrDefaultAsync(x => x.Id == id);
    ...
    public async Task AssignUsersAsync(string projectId, List<string> userIds)
    {
    ...
    public async Task<int> CountAsync() => await _db.Projects.CountAsync();
...
public class TaskService
{
    ...
    public async Task<List<Task>> ListByProjectAsync(string projectId) =>
    ...
    public async Task<Task> CreateAsync(CreateTaskRequest req)
    {
        var task = new Task
        {
    ...
    public async Task<Task?> UpdateStatusAsync(string id, TaskStatus status)
    {
    ...
    public async Task<Annotation> AnnotateAsync(string taskId, string userId, AnnotateRequest req)
    {
...
public class CustomerService
{
    ...
    public async Task<List<CustomerDto>> ListCustomersAsync() =>
        await _db.Customers.Select(c => new CustomerDto(c.Id, c.Email, c.Name, c.Company, c.IsActive, c.ApiKey, c.CreatedAt))
                           .ToListAsync();
    ...
    public async Task<int> CountAsync() => await _db.Customers.CountAsync();

    public async Task<List<CustomerProjectDto>> ListProjectsAsync(string? customerId) =>
    ...
    public async Task<CustomerProjectDto?> GetProjectAsync(string id)
    {
    ...
    public async Task<CustomerProjectDto> CreateProjectAsync(string customerId, CreateCustomerProjectRequest req)
    {
    ...
    public async Task<object> UploadFileAsync(string projectId, IFormFile file)
    {
    ...
    public async Task<List<FinalResult>> GetResultsAsync(string projectId) =>
        await _db.FinalResults.Where(r => r.CustomerProjectId == projectId).ToListAsync();

    public async Task<object> ExportAsync(string projectId, string customerId, string format)
    {
