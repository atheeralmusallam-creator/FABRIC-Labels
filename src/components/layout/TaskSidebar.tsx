  ...
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col bg-[var(--bg-secondary)] border-r border-[var(--border)] overflow-hidden">
      <div className="flex-shrink-0 px-3 py-3 border-b border-[var(--border)] grid grid-cols-4 gap-1 text-center">
        ...
        <div>
          <div className="text-[var(--text-secondary)] text-sm font-bold">{stats.pending}</div>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className={cn(
                  ...
                  index === currentIndex ? "text-[var(--text-primary)]" : "text-[var(--text-secondary)] group-hover:text-[var(--text-primary)]"
                )}>
                  <span>#{index + 1}</span>
